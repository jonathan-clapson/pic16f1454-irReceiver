...
OBJ_UART := $(wildcard hal/uart/obj/*.p1)
...
INCL := -Ihal/uart/src -Ihal/m-stack/include -Isrc 
DEFINE := 
LIBS := 
LIB_PATHS := 
...
picir: hal_dirs $(OBJ_FILES)
	$(CC) $(LD_FLAGS) $(LIB_PATHS) -o$@ $(OBJ_FILES) $(OBJ_MSTACK) $(OBJ_UART) $(LIBS)
#	xc8-bin2hex picir
